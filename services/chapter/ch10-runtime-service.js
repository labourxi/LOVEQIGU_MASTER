/**
 * Root Node runtime loader for CH10 L2 data.
 */
...
const story = readJson('data/story/ch10_chapters.json');
const relics = readJson('data/relics/ch10_relics.json');
const rights = readJson('data/rights/ch10_rights.json');
const ar = readJson('data/ar/ch10_ar-events.json');
const dcRegistryPath = path.join(ROOT, 'docs/content/DIGITAL_COLLECTIBLE_REGISTRY_CH10.md');
...
function validateCrossRefs() {
  ...
  const completion = getArEvents().find((e) => e.id === 'ar_ch10_completion_v1');
