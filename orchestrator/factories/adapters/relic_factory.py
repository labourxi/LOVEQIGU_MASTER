...
GENERATED_DIR = ROOT / "data" / "relics" / "generated"
...
class RelicFactoryAdapter:
    factory_name = "RelicFactory"
    ...
    def execute(self, task_context=None):
        ...
        payload: dict[str, Any] = {
            ...
            "record": {
                "relic_id": f"{task_id}_relic",
                "name": target,
                "source": context,
            },
        }
        output_path = GENERATED_DIR / f"{task_id}_relic.json"
