...
review_batch: ADMIN_BLESSING_UI_GUIDELINE_V1_SUPERSEDED
```
...
CURRENT_ACTIVE_ADMIN_VISUAL_SYSTEM_STATUS: FROZEN
...
```yaml
filename: ADMIN_BLESSING_UI_GUIDELINE_V1.md
path: docs/admin/visual/ADMIN_BLESSING_UI_GUIDELINE_V1.md
type: Visual Guideline (Historical)
version: V1
status: SUPERSEDED
...
note: 福文化内容迁移至活动体系 · 后台视觉由东方运营控制台承接 · 保留 · 不删除
```
...
type: Visual Guideline (Activity)
status: FROZEN
note: ADMIN_BLESSING_UI_GUIDELINE_V1 福文化内容继承方 · CURRENT_ACTIVE_ACTIVITY_VISUAL_SYSTEM
...
ADMIN_INDEX_V1
│
├── ADMIN_OPERATION_VISUAL_SYSTEM_V1    [FROZEN] ← CURRENT_ACTIVE_ADMIN_VISUAL_SYSTEM
│   └── 东方运营控制台（Oriental Operations Console）
│
├── ADMIN_BLESSING_UI_GUIDELINE_V1    [SUPERSEDED]
│   └── → ACTIVITY_BLESSING_VISUAL_GUIDELINE_V1（福文化）· ADMIN_OPERATION_VISUAL_SYSTEM_V1（后台）
│
