...
|------|:----------:|:------:|:------------:|:------:|
| `data/story/ch07_chapters.json` | PASS | `loveqigu.story.chapters.v1` | chapter shell + 5 nodes | **PASS** |
| `data/relics/ch07_relics.json` | PASS | `loveqigu.relics.v1` | 6 relics + asset_boundary | **PASS** |
| `data/rights/ch07_rights.json` | PASS | `loveqigu.rights.v1` | 5 rights + relic_refs_all | **PASS** |
| `data/ar/ch07_ar-events.json` | PASS | `loveqigu.ar.events.v1` | 6 events + asset_boundary | **PASS** |
| `docs/content/DIGITAL_COLLECTIBLE_REGISTRY_CH07.md` | Present | CH07 DC Registry | 1 entity | **PASS** |

### Story 结构检查

| Check | Result |
|-------|:------:|
| Chapter ID `ch07_field_echo` | PASS |
| 五处觉察 `total: 5` | PASS |
...
| ID | Severity | Finding |
|----|----------|---------|
| W-004 | Info | CH07 next_chapter: TBD — CH08+ Canon 未述 · 符合暂停边界 |
