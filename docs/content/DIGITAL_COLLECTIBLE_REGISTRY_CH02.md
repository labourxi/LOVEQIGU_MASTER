# Digital Collectible Registry — CH02

> **文件标识**：`DIGITAL_COLLECTIBLE_REGISTRY_CH02.md`  
> **版本**：V1.0  
> **日期**：2026-06-08  
> **状态**：Active · CH02 Digital Collectible 登记册  
> **层级**：L2 · Marketing / Communication Asset Registry  
> **触发**：`CH02_CONTENT_AUDIT` W-001  
...
本文件登记 **CH02《山门回响》** 章级 Digital Collectible 实体。

```text
CH02 AR Event Layer（ar_ch02_completion_v1）
        ↓ digital_collectible_refs
DIGITAL_COLLECTIBLE_REGISTRY_CH02（本文件）
...
> Relic ≠ Digital Collectible。本登记册 **不得** 写入 `data/relics/*`， **不得** 影响 `data/story/ch02_chapters.json` 章成逻辑。
...
| 字段 | 值 |
|------|-----|
| `source_context` | CH02 completion share flow · 章成 closure 后可接续的分享流程 |
...
| 层 | 引用 ID | 关系 |
|----|---------|------|
| AR Event | `ar_ch02_completion_v1` | `digital_collectible_refs` · closure 场域可路由至分享流程 |
| Rights | `right_ch02_share_poster` | L1 分享资格 · 路由入口 · **不是** 本资产定义 |
| Story | `n5_complete` | 章成节点上下文 · **不参与** 章成判定 |
| Relic | `relic_ch02_mountain_echo_seal` | 章成印记为 **独立** Story 资产 · 海报 **不写入** 信物持有库 |
...
> 分享海报生成 **发生在章成之后**，**不是** 章成条件，**不** 改变印谱 B 或信物状态。
...
Does not affect chapter completion logic or imprint album B progress.
...
| 版本 | 日期 | 说明 |
|------|------|------|
| V1.0 | 2026-06-08 | 首版：登记 `dc_ch02_completion_poster` · 关闭 W-001 |
...
| 文档 | 关系 |
|------|------|
| [`CH02_CONTENT_AUDIT_CREATE_REPORT.md`](CH02_CONTENT_AUDIT_CREATE_REPORT.md) | W-001 来源 |
| [`CH02_CONTENT_CANON_V1.md`](CH02_CONTENT_CANON_V1.md) | 章节方向上位 |
| [`LOVEQIGU_CONTENT_CANON_V1.md`](LOVEQIGU_CONTENT_CANON_V1.md) | 四层资产边界 |
| `data/ar/ch02_ar-events.json` | AR 引用源 |
| `data/rights/ch02_rights.json` | L1 分享路由 |
| `CONTENT_ENGINE/TOKEN_LIBRARY/digital_collectibles_v1.yaml` | CH01 同类 YAML 库（CH02 待同步可选） |

---

`DIGITAL_COLLECTIBLE_REGISTRY_CH02_COMPLETE = YES`
