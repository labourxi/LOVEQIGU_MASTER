module.exports = {
  ...
  "canonical_boundary": "CH09 AR Event Layer. Field experience and closure entry. No new lore. No Canon Gap fill.",
  "chapter_context": {
  ...
  "events": [
    ...
    },
    {
      ...
      "copy": "预览连接延伸场域；权益礼遇在探索完成后于权益中心触达。",
      "relic_refs": [
    ...
    },
    {
      ...
      "camera_enabled": false,
      "fake_ar_enabled": true,
      "description": "记念《未来之约》章成 closure 场域。五处觉察已齐备，世界留下未来印记，见证连接而非等级。",
