module.exports = {
  ...
  "canonical_boundary": "CH06 Rights Layer. Commercial and jieyuan functions isolated from ritual chain. No new lore. No Canon Gap fill.",
  "chapter_context": {
  ...
  "rights": [
    {
      "id": "right_ch06_structure_preview",
      "name": "章节结构预览",
      "chapter_id": "ch06_field_completion",
      "type": "preview",
      "status": "available",
      ...
      "description": "记念《归位觉醒》章节结构入口。用于查看探索动线与权益中心入口，不承载云门仪式链。",
    ...
    {
      "id": "right_ch06_jieyuan_free_latte",
      "name": "权益礼遇 · 免费拿铁券",
      "chapter_id": "ch06_field_completion",
      "type": "coupon",
      "status": "locked",
      ...
      "description": "记念人间觉醒探索完成后，可在权益中心领取免费拿铁权益礼遇。探索完成后可免费领取，同账号仅可获得一次。",
      "eligibility_node_id": "n3_human_completion",
      "redemption": {
        "enabled": false,
        "surface": "权益中心",
    ...
    {
      "id": "right_ch06_jieyuan_cafe_discount",
      "name": "权益礼遇 · 咖啡五折券",
      "chapter_id": "ch06_field_completion",
      "type": "coupon",
      "status": "locked",
      ...
      "description": "记念《归位觉醒》探索记念与心愿值记存达成后，可在权益中心查看咖啡五折券等权益礼遇。",
    ...
    },
    {
      ...
      "description": "记念《归位觉醒》章成后，可生成分享海报。传播资产由用户主动生成，不写入信物持有库。",
      "eligibility_node_id": "n5_complete",
      "redemption": {
        "enabled": false,
        "surface": "分享页",
